...
/* ================================================================
   ...
   ================================================================ */
const SERVICES = [
  { id:'MA-01', name:'Relajante Neuro Adaptativo', icon:'🌙', category:'Relajación', duration:'50 min', reward:65, reputation:8,
    desc:'Presiones lentas y fluidas para desenredar la tensión de cuello y hombros.' },
  { id:'MA-02', name:'Masaje Deportivo & Descompresión', icon:'💪', category:'Deportivo', duration:'50 min', reward:95, reputation:15,
    desc:'Presión clínica directa a la fascia para liberar ácido láctico y contracturas.' },
  { id:'MA-03', name:'Ayurveda & Aromaterapia', icon:'🪔', category:'Holístico', duration:'50 min', reward:78, reputation:12,
    desc:'Inmersión sensorial con óleos esenciales tibios contra la dispersión mental.' },
  { id:'MA-04', name:'Esferas Chinas & Velas Aromáticas', icon:'🕯️', category:'Inmersivo', duration:'60 min', reward:90, reputation:14,
    desc:'Resonancia térmica y cera natural para combatir el insomnio.' },
  { id:'MA-05', name:'Reductivo & Maderoterapia', icon:'🪵', category:'Estético', duration:'Sesión', reward:100, reputation:17,
    desc:'Fricción manual y maderoterapia para drenaje linfático y textura cutánea.' },
  { id:'MA-06', name:'Terapia para Parálisis Facial', icon:'🌿', category:'Clínico', duration:'45 min', reward:128, reputation:23,
    desc:'Rehabilitación gradual mediante estimulación neuromuscular focalizada.' },
  { id:'MA-07', name:'Shiatsu en Cama · Complemento', icon:'⚡', category:'Express', duration:'20 min', reward:38, reputation:4,
    desc:'Digitopuntura profunda y rápida en las zonas de mayor carga.' },
  { id:'MA-08', name:'Ritual Lomi Lomi Supremo', icon:'🌊', category:'Premium', duration:'Sesión Premium', reward:220, reputation:38,
...
/* ================================================================
   ...
   ================================================================ */
const STAFF_ROSTER = [
  { id:'sf-01', name:'Renata Ibáñez', role:'Terapeuta Junior', icon:'🧑‍⚕️', cost:260, bonus:0.05,
    desc:'Aumenta un 5% las ganancias por sesión.' },
  { id:'sf-02', name:'Ismael Coto', role:'Terapeuta Senior', icon:'🧑‍⚕️', cost:620, bonus:0.09,
    desc:'Aumenta un 9% las ganancias por sesión.' },
  { id:'sf-05', name:'Brenda Casillas', role:'Recepcionista Junior', icon:'🛎️', cost:340, bonus:0, clientBonus:1,
    desc:'Agiliza la recepción: +1 cliente por día.' },
  { id:'sf-06', name:'Yolanda Prieto', role:'Especialista en Aromaterapia', icon:'🪔', cost:560, bonus:0, categoryBonus:{ category:'Holístico', amount:0.20 },
    desc:'+20% en pagos de tratamientos de categoría Holístico.' },
  { id:'sf-07', name:'Adrián Fonseca', role:'Fisioterapeuta Deportivo', icon:'💪', cost:640, bonus:0, categoryBonus:{ category:'Deportivo', amount:0.20 },
    desc:'+20% en pagos de tratamientos de categoría Deportivo.' },
  { id:'sf-03', name:'Dulce Marín', role:'Coordinadora de Bienestar', icon:'🌸', cost:1150, bonus:0.14,
    desc:'Aumenta un 14% las ganancias y mejora la reputación general.' },
  { id:'sf-08', name:'Gustavo Nájera', role:'Esteticista Clínica', icon:'🧴', cost:1050, bonus:0, categoryBonus:{ category:'Clínico', amount:0.24 },
    desc:'+24% en pagos de tratamientos de categoría Clínico y Estético.' },
  { id:'sf-09', name:'Norma Aceves', role:'Gerente de Experiencia', icon:'✨', cost:1600, bonus:0, reputationPerDay:3,
    desc:'Suma +3 de reputación automáticamente al iniciar cada día.' },
  { id:'sf-04', name:'Óscar Beltrán', role:'Especialista Clínico', icon:'🩺', cost:2100, bonus:0.20,
    desc:'Personal de élite: +20% en cada sesión completada.' },
  { id:'sf-10', name:'Valentina Sarabia', role:'Directora de Spa', icon:'👑', cost:3400, bonus:0.22, unlocksCabin:'cb-04',
...
/* ================================================================
   ...
   ================================================================ */
const CABINS = [
  { id:'cb-01', name:'Cabina Zen', icon:'🌙', cost:900, category:'Relajación', bonus:0.15,
    desc:'Ambientada para tratamientos de Relajación. +15% si coincide la categoría.' },
  { id:'cb-02', name:'Cabina Deportiva', icon:'💪', cost:1100, category:'Deportivo', bonus:0.15,
    desc:'Equipo especializado en recuperación física. +15% en tratamientos Deportivos.' },
  { id:'cb-03', name:'Cabina Ritual', icon:'🪔', cost:1400, category:'Holístico', bonus:0.18,
    desc:'Diseñada para experiencias sensoriales completas. +18% en tratamientos Holísticos.' },
  { id:'cb-04', name:'Cabina VIP', icon:'👑', cost:2600, category:'Premium', bonus:0.28,
...
const Views = (function () {
  ...
  function renderStats() {
    ...
    Modal.open(`
      ...
      <div class="stat-row"><span class="label">💝 Propinas acumuladas</span><span class="value pos">◈ ${s.totalTipsReceived||0}</span></div>
  ...
  return { renderStaff, renderUpgrades, renderStats, renderCabins };
})();
V.Views = Views;
